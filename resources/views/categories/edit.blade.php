...
@section('content')
    @include('layouts.partials/page-title', ['subtitle' => 'CMS SJA', 'title' => 'Edit Category'])

    <div class="card">
        <div class="card-header">
            <h6 class="card-title text-base font-semibold text-default-800">Edit Category: {{ $category->name }}</h6>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('categories.update', $category->id) }}" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input class="form-input" id="name" name="name" value="{{ old('name', $category->name) }}" placeholder="e.g. Residential Construction" type="text" required autofocus />
                    ...
                    <div>
                        ...
                        <input class="form-input" id="slug" name="slug" value="{{ old('slug', $category->slug) }}" placeholder="e.g. residential-construction" type="text" required />
