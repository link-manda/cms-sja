...
<head>
    @include('partials.public-head', [
        'pageTitle' => 'Recover Account Password - PT Sistem Jaya Abadi',
        'seoTitle' => 'Recover Account Password - PT Sistem Jaya Abadi',
        'seoDescription' => 'Request an administrative password reset link for the PT Sistem Jaya Abadi management portal.',
...
<body class="text-primary antialiased selection:bg-secondary selection:text-white relative overflow-x-hidden min-h-screen bg-background flex flex-col justify-center">
    ...
    <div class="relative min-h-screen w-full flex bg-[#FAF9F6] text-primary antialiased">
        ...
        <!-- 1. Left Panel: Password Reset Request Form (50% Desktop, 100% Mobile) -->
            ...
            <div class="flex items-center justify-between">
                <a href="/" class="flex items-center gap-3 group">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-[9px] uppercase tracking-[0.2em] font-bold text-muted">Recovery Protocol</span>
                    </div>
                </a>
            ...
            <div class="w-full max-w-md mx-auto my-auto py-8">
                ...
                <div class="mb-8">
                    ...
                    <h1 class="font-display text-3xl sm:text-4xl font-extrabold text-primary tracking-tight leading-tight mb-2">
                        Account <span class="text-gradient">Recovery</span>
                    </h1>
                    <p class="text-xs sm:text-sm text-muted leading-relaxed">
                        Enter your registered administrator email address and we will dispatch a cryptographically secure password reset link.
                    </p>
                </div>

                <!-- Session Flash Message (Link Dispatched) -->
                @if (session('status'))
                ...
                @if ($errors->any())
                    <div class="mb-6 p-4 rounded-2xl bg-secondary/10 border border-secondary/20 flex items-start gap-3 shadow-sm">
                        ...
                        <div class="text-xs font-semibold text-secondary leading-relaxed">
                            <p>We could not find an administrative account matching this email address.</p>
                        </div>
                    </div>
                @endif
        ...
        <div class="hidden lg:block lg:w-1/2 relative bg-primary overflow-hidden min-h-screen">
            ...
            <div class="absolute inset-0">
                <img src="{{ asset('assets/office_sesetan.png') }}" alt="Architecture Cover"
            ...
            <div class="absolute bottom-12 left-12 right-12 z-10">
                <div class="glass-card bg-primary/80 backdrop-blur-xl border border-white/15 p-8 rounded-[2rem] shadow-2xl text-white">
                    ...
                    <p class="text-xs text-white/70 leading-relaxed mb-6 max-w-lg">
                        Administrative access keys are cryptographically signed with short-lived expiration windows to prevent unauthorized session elevation.
                    </p>

                    <!-- Credibility Metrics Bar -->
                    <div class="grid grid-cols-3 gap-4 pt-4 border-t border-white/10 text-center">
                        <div>
                            <span class="font-display font-extrabold text-lg text-white block">256-Bit</span>
                            <span class="text-[9px] uppercase font-bold tracking-wider text-white/60">Encryption</span>
                        </div>
                        <div class="border-x border-white/10">
                            <span class="font-display font-extrabold text-lg text-secondary block">60 Mins</span>
                            <span class="text-[9px] uppercase font-bold tracking-wider text-white/60">Token Window</span>
                        </div>
                        <div>
